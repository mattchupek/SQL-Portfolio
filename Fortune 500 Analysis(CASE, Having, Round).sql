/* 
This SQL queries data from a false Fortune 500 database. 
I used it to answer common questions using aggregate functions(AVG, SUM, COUNT, MIN, etc, and logical operators like AND and OR. 
I also used functions like CASE, HAVING, GROUP BY, and ORDER BY. I began by creating a table then I answered 5 questions about the data.
*/
...
SELECT 
	company_name 
	,CASE 
		WHEN employees >=2000000 THEN '2 million+'
		WHEN employees >=1000000 THEN '1 million+'
		WHEN employees >=100000 THEN '100k+'
		WHEN employees >=10000 THEN '10k+'
		WHEN employees >=5000 THEN '5k+'
		WHEN employees >=4000 THEN '4k+'
		WHEN employees >=3000 THEN '3k+'
		WHEN employees >=2000 THEN '2k+'
		WHEN employees >=1000 THEN '1k+'
		ELSE 'Under 1k' 
	END 'employee_count'
